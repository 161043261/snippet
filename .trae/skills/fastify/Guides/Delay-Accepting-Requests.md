...
`/ping` is more commonly associated with _liveness_ checks and that would be
the responsibility of a _readiness_ check. The curious reader can get more info
